...
COIN_DAEMON='/usr/local/bin/1x2coind'
COIN_CLI='/usr/local/bin/1x2coin-cli'
COIN_REPO='https://github.com/1X2coin/1X2coin/releases/download/v1.0.0/1x2coin-1.0.0-x86_64-linux-gnu.tar.gz'
COIN_NAME='1X2Coin'
COIN_PORT=9214
